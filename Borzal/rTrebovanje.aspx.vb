...
Partial Class rTrebovanje
    ...
    Private Sub PopuniTabeluMB()
        ...
        SessionUpit()
        SelectSQL = Session("UpitTrebovanje")
        'UslovWHERE()
        ...
        Session("UpitTrebovanje") = SelectSQL
    ...
    Protected Sub SessionUpit()
        ...
        SelectSQL = "SELECT *,DATALENGTH(BROJ) as broj2 FROM vTREBOVANJE ORDER BY BROJ2,BROJ, RBR"
