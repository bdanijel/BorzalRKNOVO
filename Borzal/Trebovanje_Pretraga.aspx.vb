...
#Region "COMBO PRETRAGA"
    Private Sub PopuniCOMBO()
        ...
        Dim UpitBROJ As String = "SELECT DISTINCT BROJ FROM vTREBOVANJE ORDER BY BROJ"
...
#Region "EXCEL EXPORT"
    Protected Sub EXCEL_Grid(ByVal ID As Integer)
        ...
        Dim IzvestajNaziv As String = "TREBOVANJE" & "_" & DateTime.Now.ToString("yyyyMMdd_HHmm") & ".xls"
        Dim UpitExcel As String = "SELECT ID,BROJ,RBR,ID_SIROVINE,JM,KOLICINA,DATUM FROM TREBOVANJE ORDER BY ID"
        ...
        If Me.gvExcel.Rows.Count > 0 Then
            ...
            Using sw As New StringWriter()
                ...
                Me.gvExcel.Caption = "<h4>" & "TREBOVANJE_" & "_" & DateTime.Now.ToString("dd.MM.yyyy.") & "</h4>"
