...
<%--            <div class="auto-style1">
            ...
            <asp:ObjectDataSource ID="dsPredatnica" runat="server" SelectMethod="DajDS_IzUpita_lokal" TypeName="ADM_MM">
                <SelectParameters>
                    <asp:SessionParameter Name="Upit" DefaultValue="SELECT *,DATALENGTH(BROJ) as broj2 FROM vPREDATNICA ORDER BY BROJ2,BROJ,RBR"  SessionField="UpitPredatnica" Type="String" />
