<%@ Page Title="" Language="VB" MasterPageFile="~/zADM_BORZAL_Master.master" AutoEventWireup="false" CodeFile="rSirovine.aspx.vb" Inherits="rSirovine" %>
...
<%--            <div class="auto-style1">
            ...
            <asp:ScriptManager ID="ScriptManager1" runat="server">
             ...
             <br />
            <asp:ObjectDataSource ID="dsSirovine" runat="server" SelectMethod="DajDS_IzUpita_lokal" TypeName="ADM_MM">
                <SelectParameters>
                    <asp:SessionParameter Name="Upit" DefaultValue="SELECT * FROM SIROVINE"  SessionField="UpitSirovine" Type="String" />
               ...
               <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Height="100%" AsyncRendering="False" SizeToReportContent="True"  ClientIDMode="AutoID">
                <LocalReport ReportPath="Izvestaji\rSirovine.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="dsSirovine" Name="dsSirovine" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
                 </div>
...
<%--        function setMB(a) {
        ...
        history.pushState(null, null, 'rSirovine.aspx');
