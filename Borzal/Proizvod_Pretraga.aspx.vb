...
Partial Class Proizvod_Pretraga
...
#Region "GENERISANJE MB"
    ...
    Private Sub PopuniTabeluMB()
        ...
        MBListaTitle.InnerHtml = "Spisak proizvoda"
...
#Region "COMBO PRETRAGA"
    Private Sub PopuniCOMBO()
        ...
        Dim UpitNAZIV As String = "SELECT DISTINCT NAZIV FROM PROIZVOD ORDER BY NAZIV"
...
#Region "EXCEL EXPORT"
    Protected Sub EXCEL_Grid(ByVal ID As Integer)
        ...
        Dim IzvestajNaziv As String = "PROIZVOD" & "_" & DateTime.Now.ToString("yyyyMMdd_HHmm") & ".xls"
        ...
        If Me.gvExcel.Rows.Count > 0 Then
            ...
            Using sw As New StringWriter()
                ...
                Me.gvExcel.Caption = "<h4>" & "PROIZVOD_" & "_" & DateTime.Now.ToString("dd.MM.yyyy.") & "</h4>"
