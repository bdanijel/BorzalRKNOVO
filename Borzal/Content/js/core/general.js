...
$(function () {
    ...
    $('#navbar-second').on('affixed.bs.affix', function () {
        ...
        $('form').addClass('navbar-affixed-top');
        $('#navbar-primary').addClass('bg-primary-600');
        $('#navbar-primary').removeClass('navbar-xs');
    });

    // When on top
    $('#navbar-second').on('affixed-top.bs.affix', function () {
        $(this).next().css('margin-top', '');
        $('form').removeClass('navbar-affixed-top');
        $('#navbar-primary').removeClass('bg-primary-600');
        $('#navbar-primary').addClass('navbar-xs');
    });
