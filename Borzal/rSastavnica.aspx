<%@ Page Title="" Language="VB" MasterPageFile="~/zADM_BORZAL_Master.master" AutoEventWireup="false" CodeFile="rSastavnica.aspx.vb" Inherits="rSastavnica" %>
...
<%--         <div id="filterTable" class="row no-border">
        ...
        <div class="row">
            ...
            <asp:ObjectDataSource ID="dsSastavnica" runat="server" SelectMethod="DajDS_IzUpita_lokal" TypeName="ADM_MM">
                <SelectParameters>
                    <asp:SessionParameter Name="Upit" DefaultValue="SELECT *,DATALENGTH(BROJ) as broj2 FROM vSASTAVNICE ORDER BY BROJ2,BROJ, RBR"  SessionField="UpitSastavnica" Type="String" />
               ...
               <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Height="100%" AsyncRendering="False" SizeToReportContent="True"  ClientIDMode="AutoID">
                <LocalReport ReportPath="Izvestaji\rSastavnica.rdlc">
                    <DataSources>
...
<%--        function setMB(a) {
        ...
        history.pushState(null, null, 'rSastavnica.aspx');
