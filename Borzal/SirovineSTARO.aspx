<%@ Page Title="" Language="VB" MasterPageFile="~/zADM_BORZAL_Master.master" AutoEventWireup="false" CodeFile="SirovineSTARO.aspx.vb" Inherits="Sirovine" %>
...
<asp:Content ID="cBody" ContentPlaceHolderID="cphBody" Runat="Server">
 ...
 <div class="content-divider text-muted form-group no-margin-top no-margin-bottom"><span></span></div>
                             ...
                             <div class="col-md-12">
                                <div class="input-group-btn text-center">
                                    <button type="button" id="btnPotvrdiSIROVINA" runat="server" onserverclick="btnPotvrdiSIROVINA_Click" data-loading-text="ПОНИШТИ ИЗБОР <i class='icon-sync spinner text-white position-right'></i>" class="btn btn-info btn-xs btn-loading text-size-mini">ПОНИШТИ ИЗБОР <i class="icon-sync position-right"></i></button>
                                    <asp:LinkButton ID="btnPotvrdiSIROVINA2" runat="server" OnClick="btnPotvrdiSIROVINA_Click" CssClass="btn btn-info btn-xs bg-info-700" style="left: 0px; top: 6px; margin-bottom:40px">POTVRDI <i class="icon-checkmark3 position-right"></i></asp:LinkButton><br />
                                     </div>
                            </div>
                   </div>
 ...
 <%-- spisak gresaka --%>
    ...
    <asp:ObjectDataSource ID="odsSIROVINA" runat="server" SelectMethod="DajDS_IzUpita_lokal" TypeName="ADM_MM">
        <SelectParameters>
            <asp:SessionParameter Name="Upit" DefaultValue="SELECT * FROM SIROVINE" SessionField="UpitSIROVINA" Type="String" />
