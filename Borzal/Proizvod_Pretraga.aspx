<%@ Page Title="" Language="VB" MasterPageFile="~/zADM_BORZAL_Master.master" AutoEventWireup="false" CodeFile="Proizvod_Pretraga.aspx.vb" Inherits="Proizvod_Pretraga" %>
                            ...
                            <div class="table-responsive">                        
                                <asp:GridView ID="gvMB" runat="server" CssClass="table table-bordered table-xxs"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="NAZIV PROIZVODA" HeaderStyle-Width="120" SortExpression="NAZIV">
                                             <ItemTemplate>
