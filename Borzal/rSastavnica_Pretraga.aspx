<%@ Page Title="" Language="VB" MasterPageFile="~/zADM_BORZAL_Master.master" AutoEventWireup="false" CodeFile="rSastavnica_Pretraga.aspx.vb" Inherits="rSastavnica_Pretraga" %>
...
<%--            <div class="auto-style1">
             ...
             <br />
            <asp:ObjectDataSource ID="dsSastavnica" runat="server" SelectMethod="DajDS_IzUpita_lokal" TypeName="ADM_MM">
                <SelectParameters>
                    <asp:SessionParameter Name="Upit" DefaultValue="SELECT *,DATALENGTH(BROJ) as broj2 FROM vSASTAVNICA ORDER BY BROJ2,BROJ, RBR"  SessionField="UpitSastavnica" Type="String" />
               ...
               <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Height="100%" AsyncRendering="False" SizeToReportContent="True"  ClientIDMode="AutoID">
                <LocalReport ReportPath="Izvestaji\rSastavnica_Pretraga.rdlc">
                    <DataSources>
                        <rsweb:ReportDataSource DataSourceId="dsSastavnica" Name="dsSastavnica" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
                 </div>
...
<%--        function setMB(a) {
        ...
        history.pushState(null, null, 'rSastavnica_Pretraga.aspx');
