                                ...
                                <div class="form-horizontal">
                                    <div class="form-group form-group-xs no-margin-bottom">
                                        <div class="row">
                                            ...
                                            <%-- <div class="input-group">--%>
                                            <div class="col-md-4">
                                                <asp:DropDownList ID="ddlSirovinaID" runat="server" CssClass="col-md-4 select-size-xs" AutoPostBack="true"></asp:DropDownList>
                                            </div>
                                            <%-- </div>--%>
                        ...
                        <div class="row mb-10">
                            <div class="col-md-12">
                                <div class="input-group-btn text-center">
                                    <asp:LinkButton ID="btnPotvrdiSASTAVNICA" runat="server" OnClick="btnPotvrdiSASTAVNICA_Click" CssClass="btn btn-info btn-xs bg-info-700" Style="left: 0px; top: 6px">POTVRDI <i class="icon-checkmark3 position-right"></i></asp:LinkButton><br />
                                </div>
                            </div>
                        </div>
                    </div>
