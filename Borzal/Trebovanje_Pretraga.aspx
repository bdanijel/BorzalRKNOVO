<%@ Page Title="" Language="VB" MasterPageFile="~/zADM_BORZAL_Master.master" AutoEventWireup="false" CodeFile="Trebovanje_Pretraga.aspx.vb" Inherits="Trebovanje_Pretraga" %>
                        ...
                        <div class="panel no-border"><div class="SPRLJ table-responsive">                        
                                <asp:GridView ID="gvExcel" runat="server" CssClass="table table-bordered table-xxs"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ID_SIROVINE" HeaderText="ID_SIROVINE" />
...
<%--        function setMB(a) {
        ...
        history.pushState(null, null, 'Trebovanje_Pretraga.aspx');
